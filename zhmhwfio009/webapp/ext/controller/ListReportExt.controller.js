sap.ui.define(
    "com.readians.hmh.zhmhwfio009.ext.controller.ListReportExt", [
        "sap/ui/model/Filter", 
        ...
        return {
            getCustomAppStateDataExtension: function (oCustomData) {
                ...
                if (oCustomData) {
                    var oCustomField1 = this.oView.byId("Cont_test01");
                    if (oCustomField1) {
                        oCustomData.CsFIPo_test01 = oCustomField1.getSelectedKey();
                    }
                }
            },
            ...
            restoreCustomAppStateDataExtension: function (oCustomData) {
                ...
                if (oCustomData) {
                    if (oCustomData.CsFIPo_test01) {
                        var oComboBox = this.oView.byId("Cont_test01");
                        oComboBox.setSelectedKey(
                            oCustomData.CsFIPo_test01
                        );
                    }
                }
            },
            onBeforeRebindTableExtension: function(oEvent) {
                ...
                if (oSmartFilterBar instanceof SmartFilterBar) {
                    var oCustomControl = oSmartFilterBar.getControlByKey("Csfikey_filter01");
